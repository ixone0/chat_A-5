...
import { VideoCallOverlay, VoiceCallBar, CallingMinimizedBar } from "../components/ActiveCallOverlay";
...
const Chat = () => {
  ...
  return (
    <div className="chat-container">
      ...
      {calling && callingMinimized && (
        <CallingMinimizedBar calling={calling} endCall={endCall} onExpand={() => setCallingMinimized(false)} />
      )}

      {activeCall && activeCall.call_type === 'video' && (
        <VideoCallOverlay
          activeCall={activeCall} callElapsedTime={callElapsedTime}
          callParticipants={callParticipants} remoteStreams={remoteStreams}
          localVideoRef={localVideoRef} remoteVideoRef={remoteVideoRef}
          currentUser={currentUser} isMicMuted={isMicMuted} isCameraOff={isCameraOff}
          toggleMic={toggleMic} toggleCamera={toggleCamera}
          endCall={endCall} leaveCall={leaveCall}
        />
      )}
      ...
      {activeCall && activeCall.call_type !== 'video' && (
        <VoiceCallBar
          activeCall={activeCall} callElapsedTime={callElapsedTime}
          callParticipants={callParticipants} remoteStreams={remoteStreams}
          currentUser={currentUser} isMicMuted={isMicMuted}
          toggleMic={toggleMic} endCall={endCall} leaveCall={leaveCall}
          voiceBarExpanded={voiceBarExpanded} setVoiceBarExpanded={setVoiceBarExpanded}
        />
      )}
